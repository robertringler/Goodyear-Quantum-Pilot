...
class MaterialState:
    ...
    def is_serviceable(self) -> bool:
        ...
        return (
            self.tensile_strength > 10.0 and self.elongation > 200 and self.surface_condition > 0.5
        )
...
class UVDegradation:
    ...
    def __init__(
        ...
        self.protection_factor = 1.0 + 0.5 * self.antioxidant + 0.1 * self.carbon_black
    ...
    def simulate_field_aging(
        ...
        for year in range(int(years)):
            for season in seasons:
                conditions = EnvironmentalConditions.from_climate_zone(climate_zone, season)
        ...
        return {
            ...
            "years_serviceable": (sum(r["is_serviceable"] for r in results) * 0.25),
