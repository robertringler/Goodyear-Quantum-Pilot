...
class Material:
    ...
    def predict_tire_performance(
        ...
        # Overall score
        weights = {
            "passenger": {"wet_grip": 0.3, "wear_resistance": 0.3, "rolling_resistance": 0.3, "heat_resistance": 0.1},
            "performance": {"wet_grip": 0.4, "wear_resistance": 0.2, "rolling_resistance": 0.2, "heat_resistance": 0.2},
            "racing": {"wet_grip": 0.5, "wear_resistance": 0.1, "rolling_resistance": 0.1, "heat_resistance": 0.3},
            "off_road": {"wet_grip": 0.2, "wear_resistance": 0.4, "rolling_resistance": 0.2, "heat_resistance": 0.2},
        }
