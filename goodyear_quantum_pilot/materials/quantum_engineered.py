...
def create_quantum_sbr(
    ...
    # Set properties
    material.set_property(PropertyType.TENSILE_STRENGTH, 28.0 * quantum_factor, "MPa",
    ...
    material.set_property(PropertyType.RESILIENCE, 70.0 * quantum_factor, "%",
                          quantum_enhanced=True)
    material.set_property(PropertyType.ABRASION_RESISTANCE, 150.0 * quantum_factor, "index",
                          quantum_enhanced=True)
    material.set_property(PropertyType.FATIGUE_LIFE, 1e7 * quantum_factor, "cycles",
                          quantum_enhanced=True)
    material.set_property(PropertyType.QUANTUM_COHERENCE, coherence, "μs",
                          quantum_enhanced=True)
    material.set_property(PropertyType.TUNNELING_PROBABILITY, tunneling_prob, "dimensionless",
                          quantum_enhanced=True)
    material.set_property(PropertyType.ENTANGLEMENT_DENSITY, entanglement, "pairs/nm³",
                          quantum_enhanced=True)
...
def create_tunneling_crosslink_material(
    ...
    material.set_property(PropertyType.CROSSLINK_STABILITY, 0.95, "fraction",
                          quantum_enhanced=True)
    material.set_property(PropertyType.TENSILE_STRENGTH, 25.0 * enhancement, "MPa",
                          quantum_enhanced=True)
    material.set_property(PropertyType.FATIGUE_LIFE, 5e6 * enhancement, "cycles",
                          quantum_enhanced=True)
...
def create_entangled_lattice_material(
    ...
    material.set_property(PropertyType.ENTANGLEMENT_DENSITY, entanglement_density, "pairs/nm³",
                          quantum_enhanced=True)
    material.set_property(PropertyType.TENSILE_STRENGTH, 30.0 * nonlocal_factor, "MPa",
                          quantum_enhanced=True)
    material.set_property(PropertyType.TEAR_STRENGTH, 100.0 * nonlocal_factor, "kN/m",
                          quantum_enhanced=True)
...
for variant, lattice, pairs in _qel_configs:
    key = f"QEL-{variant}"
    QUANTUM_MATERIAL_CATALOG[key] = create_entangled_lattice_material(
        variant, lattice, pairs
    )
